<template>
  <div class="app-container">
    <el-form ref="form" :model="form">
      ...
      <el-form-item>
        <el-input v-model="form.repeatPassword" type="password" placeholder="确认密码" />
      </el-form-item>
      <el-form-item>
...
export default {
  ...
  methods: {
    onSubmit() {
      const pass = this.form.oldPassword
      const newPass = this.form.newPassword
      const confirmPass = this.form.repeatPassword
      ...
      updatePassword(this.form).then(r => {
        if (r.code === 0) {
